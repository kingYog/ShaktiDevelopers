package com.yogeshborhade.shaktidevelopers.Notification;
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    NotificationScheduler.setReminder(SetNotification.this, AlarmReceiver.class, localData.get_hour(), localData.get_min());
                    ll_set_time.setAlpha(1f);
                } else {
                    Log.d(TAG, "onCheckedChanged: false");
                    NotificationScheduler.cancelReminder(SetNotification.this, AlarmReceiver.class);
                    ll_set_time.setAlpha(0.4f);
                }
